  ...
  return (
    <SigninStyled>
      <form>
        ...
        <Input className="input" label="Confirmar senha" type={isVisible ? "text" : "password"} icon={<PasswordIconComponent onClick={( ) => setIsVisible(!isVisible)} isVisible={isVisible} />} />
        
        <a href="" className="forgot"></a>

        <Button onClick={( ) => nav("/home")} label="Cadastrar" />

        <a href="/signin">Já possui conta ?</a>
      </form>
    </SigninStyled>
  );
};